...
├── student_controller.py             # Handles student's account operations
├── subject_controller.py             # Handles student's enrollment
├── admin_controller.py               # Handles Admin's operations
│
